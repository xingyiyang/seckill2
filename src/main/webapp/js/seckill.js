var curPath = window.document.location.href; // http://localhost:8080/seckill/seckill/1001/detail
var pathName = window.document.location.pathname;  // /seckill/seckill/1001/detail
var localhostPath = curPath.substring(0,curPath.indexOf(pathName)); // http://localhost:8080
var projectName = pathName.substring(0,pathName.substr(1).indexOf('/')+1); // /seckill
var basePath = localhostPath+projectName+"/"; // http://localhost:8080/seckill/
